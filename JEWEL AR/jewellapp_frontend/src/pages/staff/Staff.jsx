...
const Staff = () => {
  ...
  const getStaff = async () => {
    let staffresult = await fetch(config.apiurl + "/api/staff/getstaff");
 ...
 const[staffid,setStaffId]=useState("");
  ...
  const handleStaffsubmit = async () => {
    ...
    let methodapi = "";
    if (updateid) {
        apistaffurl = config.apiurl+ "/api/staff/" + updateid;
        methodapi = "put";
    } else {
        apistaffurl = config.apiurl + "/api/staff/create";
        methodapi = "post";
    } 
    ...
    const getStaffedit = async (editid) => {
      let staffeditdetails = await fetch(
        config.apiurl + "/api/staff/" + editid,
        {
          method: "get",
          // headers: {
          //   Authorization: "bearer " + accesstoken.data.access_token,
      ...
      const deleteStaff = async (id) => {
        let deletestaff = await fetch(config.apiurl + "/api/staff/" +id, {
          method: "Delete",
        //   headers: {
        //     Authorization: "bearer " + accesstoken.data.access_token,
        //   },
                        ...
                        <table class="table align-items-center mb-0 ">
                          <thead>
                            <tr>
                              ...
                              <th class="text-secondary opacity-7 ps-2"># Staff ID</th>
